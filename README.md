...
| [AGT-3](docs/features/AGT-3-bounded-note-tools.md) | Not Started | Bounded note tools for search, note read, and draft assembly          | L    | Tool calls delegate to `SearchWorkflow` / `IDocumentStore`; no vault writes; fixed high testing budgets; covers REQ-007 S3/S4/S9 |
