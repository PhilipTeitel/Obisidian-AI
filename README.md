...
| ID                                                                                                                           | Status      | Story                                                                 | Size | Notes                                                                                                                                                                                                                                                                 |
| ---------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------------------------------------------------------------- | ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [VEC-0](docs/features/VEC-0-spike-wa-sqlite-sqlite-vec-obsidian-electron-bundle.md)                                            | Not Started | Spike: wa-SQLite + sqlite-vec in Obsidian/Electron bundle             | M    | Choose packages, esbuild wiring, proof of vec0 create/query on disk outside vault. Blocks VEC-2–4. See plan Phase 0.                                                                                                                                                 |
